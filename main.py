...
@app.get("/add")
def add_imei(imei: str, taskId: str, background_tasks: BackgroundTasks, new_format=1):
    ...
    # else:
    background_tasks.add_task(service_threaded.add_imei, imei, taskId, config.sec_interval, 1)
